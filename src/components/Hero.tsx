...
import guestPhotoCard from '../assets/images/guestPhotoCard.png'
import guestPhoto from '../assets/images/guestPhoto.jpg'
    ...
    <div className='flex flex-col md:flex-row gap-8'>
      <div className="flex flex-col text-center mb-16 items-center justify-center">
          <h1 className="text-2xl md:text-4xl font-bold -mb-4 animate-fade-in">
            <span className="text-yellow-400">We Welcome</span>
            <br />
            PMFJ LION MANOJ BABUR
          </h1>
          <h4 className="text-xl md:text-xl font-bold mb-6 animate-fade-in">
            <br />
          District Governor
          </h4>
          <img src={guestPhoto} alt="guestPhoto" className="w-64 h-64 rounded-full"/>
        </div>
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://wa.me/919869253803?text=I+want+to+join+Lions+Club+Marol%21" target="_blank" rel="noopener noreferrer" className="bg-yellow-500 hover:bg-yellow-400 text-blue-900 font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center">
